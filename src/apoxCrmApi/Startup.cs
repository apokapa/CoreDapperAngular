    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors(options =>
            {
                ...
                builder => builder.WithOrigins("http://coredapperclient.azurewebsites.net","http://localhost:10505", "http://apoxclient.azurewebsites.net").AllowAnyHeader()
                                                                                                                    .AllowAnyMethod());
            });
